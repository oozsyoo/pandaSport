...
public class test21 extends TestCaseBase {
    @Autowired
    ...
    public void loginJjx() {
        PropConfig.setAppBin(FileTools.getFile("res\\",0,20));
    }
    @Test(dataProviderClass = TestCaseData.class, dataProvider = "OnLineTest21", description = "玩法")
    public void test(List<String> playWay, List<String> playWays, ConstantEnum privacySettings, String multiples,String  version) {
        ...
        purchaseService.testZq( playWay,privacySettings, multiples, playWays,version);
