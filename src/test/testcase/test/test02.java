...
public class test02 extends TestCaseBase {
    @Autowired
    ...
    public void loginJjx() {
        PropConfig.setAppBin(FileTools.getFile("res\\",0,1));


    }
    @Test(dataProviderClass = TestCaseData.class, dataProvider = "OnLineTest02", description = "玩法")
